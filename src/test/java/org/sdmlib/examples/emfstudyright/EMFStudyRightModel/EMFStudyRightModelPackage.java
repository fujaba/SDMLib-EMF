 ...
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel modelDirectory='/SDMLib-EMF/src/test/java' basePackage='org.sdmlib.examples.emfstudyright'"
 * @generated
 */
public interface EMFStudyRightModelPackage extends EPackage
{
   ...
   /**
    * The feature id for the '<em><b>Friends Rev</b></em>' reference list.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    * @ordered
    */
   int STUDENT__FRIENDS_REV = 8;
    ...
    * @ordered
    */
   int TEACHING_ASSISTANT__FRIENDS_REV = STUDENT__FRIENDS_REV;
   ...
   /**
    * The feature id for the '<em><b>Doors Rev</b></em>' reference list.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    * @ordered
    */
   int ROOM__DOORS_REV = 4;
   ...
   /**
    * Returns the meta object for the reference list '{@link org.sdmlib.examples.emfstudyright.EMFStudyRightModel.Student#getFriendsRev <em>Friends Rev</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference list '<em>Friends Rev</em>'.
    * @see org.sdmlib.examples.emfstudyright.EMFStudyRightModel.Student#getFriendsRev()
    * @see #getStudent()
    * @generated
    */
   EReference getStudent_FriendsRev();
   ...
   /**
    * Returns the meta object for the reference list '{@link org.sdmlib.examples.emfstudyright.EMFStudyRightModel.Room#getDoorsRev <em>Doors Rev</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference list '<em>Doors Rev</em>'.
    * @see org.sdmlib.examples.emfstudyright.EMFStudyRightModel.Room#getDoorsRev()
    * @see #getRoom()
    * @generated
    */
   EReference getRoom_DoorsRev();
   ...
   interface Literals
   {
      ...
      /**
       * The meta object literal for the '<em><b>Friends Rev</b></em>' reference list feature.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */
      EReference STUDENT__FRIENDS_REV = eINSTANCE.getStudent_FriendsRev();
      ...
      /**
       * The meta object literal for the '<em><b>Doors Rev</b></em>' reference list feature.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */
      EReference ROOM__DOORS_REV = eINSTANCE.getRoom_DoorsRev();
