...
public class StudentImplPO extends PatternObject<StudentImplPO, StudentImpl>
{
   ...
   public StudentImplPO hasFriendsRev(StudentPO tgt)
   {
      return hasLinkConstraint(tgt, Student.PROPERTY_FRIENDSREV);
   }

   public StudentImplPO createFriendsRev(StudentPO tgt)
   {
   ...
   public StudentSet getFriendsRev()
   {
      if (this.getPattern().getHasMatch())
      {
         return ((Student) this.getCurrentMatch()).getFriendsRevSet();
      }
      return null;
   }
