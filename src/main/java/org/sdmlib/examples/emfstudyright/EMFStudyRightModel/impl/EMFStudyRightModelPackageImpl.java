...
public class EMFStudyRightModelPackageImpl extends EPackageImpl implements EMFStudyRightModelPackage
{
    ...
    * @generated
    */
   public EReference getStudent_FriendsRev()
   {
   ...
   {
      return (EReference)studentEClass.getEStructuralFeatures().get(9);
   }
    ...
    * @generated
    */
   public EReference getRoom_DoorsRev()
   {
   ...
   public void createPackageContents()
   {
      ...
      createEReference(studentEClass, STUDENT__FRIENDS_REV);
      ...
      createEReference(roomEClass, ROOM__DOORS_REV);
   ...
   public void initializePackageContents()
   {
      ...
      initEReference(getStudent_Friends(), this.getStudent(), this.getStudent_FriendsRev(), "friends", null, 0, -1, Student.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getStudent_FriendsRev(), this.getStudent(), this.getStudent_Friends(), "friendsRev", null, 0, -1, Student.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      ...
      initEReference(getRoom_Doors(), this.getRoom(), this.getRoom_DoorsRev(), "doors", null, 0, -1, Room.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getRoom_DoorsRev(), this.getRoom(), this.getRoom_Doors(), "doorsRev", null, 0, -1, Room.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
